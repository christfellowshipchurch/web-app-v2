const contentBlocks = [
  {
    ...
    htmlContent: `<div><p>No longer do you have to look up the directions on how to get there, wonder what time the service starts, or worry about what to expect when you arrive.</p><p>Let us do all of that work for you.</p><p>When you set a reminder today, we’ll send you a personalized email with all the information you’ll need prior to your visit here at Christ Fellowship.</p><p>That’s right! We’ll let you know exactly how to get here, when the service starts, what you can expect when you arrive, and more. </p><p>So all you have to do is sit back, relax, and enjoy your first visit to your future church home.</p><p><br></p></div>`,
    actions: [
      {
