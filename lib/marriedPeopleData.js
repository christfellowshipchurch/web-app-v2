export const faqData = [
  {
    ...
    description:
      'Whether you are requesting a Christ Fellowship pastor to officiate a wedding or considering a wedding at one of our church venues, all couples must complete the <a style="display: inline;" href="https://www.christfellowship.church/groups/search?preferences=&text=before+you+say+i+do">Before You Say I Do</a> class and an online assessment when they plan to be married by a Christ Fellowship pastor.',
  },
  {
    title: 'WHAT VENUES ARE AVAILABLE',
    description:
      'While we do not host wedding receptions at our venues, we offer venues of varying sizes for a memorable wedding experience. Our venues include: Trinity Chapel, Trinity Auditorium and Smith Chapel (at our South Campus in Palm Beach Gardens.)',
  },
  {
...
export const carouselData = [
  {
    title: 'Smith Chapel',
    image: '/marriage/slides/smith-auditorium.webp',
    subtitle: 'Seats 400 People',
  },
  {
    title: 'Trinity Auditorium',
    image: '/marriage/slides/trinity-auditorium.webp',
    subtitle: 'Seats 325 People',
  },
  {
    title: 'Trinity Chapel',
    image: '/marriage/slides/trinity-chapel.webp',
    subtitle: 'Seats 90 People',
  },
];
