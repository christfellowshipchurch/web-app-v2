module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/firstrespondermeals', destination: '/first-responder-meals-help-us-care-for-our-first-responders-on-thanksgiving-2024', permanent: true },
      ...
      { source: '/christmasspectacular', destination: '/long-hollows-christmas-spectacular-a-christmas-celebration-for-the-whole-family', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49340348', permanent: true }
    ];
  },
};
