  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: '/:slug',
        permanent: false,
      }, // reboot this stupid thing notes fix rev again
      ...
      { source: 'https://longhollow.com/volunteering', destination: '/next-steps/volunteer', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49369310', permanent: true }
    ];
  },
};
