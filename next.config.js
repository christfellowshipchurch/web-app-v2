module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/wednesday', destination: '/wednesdaysatlhwinter-2024', permanent: true },
      { source: '/partner', destination: '/get-strong-ministries', permanent: true },
      ...
      { source: '/rhythms', destination: '/rhythms-feb2024', permanent: true },
      ...
      { source: '/servelink', destination: '/find-a-way-to-use-your-gifts-at-serve-link', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49202806', permanent: true }
    ];
  },
};
