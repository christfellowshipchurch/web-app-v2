module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/marriageconference', destination: '/theknotmarriageconference', permanent: true },
      ...
      { source: '/studentmissions', destination: 'https://longhollow.com/studentspringbreakmissions2023', permanent: true },
      ...
      { source: '/servelink', destination: 'https://longhollow.com/serve-link', permanent: true },
      ...
      { source: '/offering', destination: '/be-a-force-for-good-through-this-years-easter-offering', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49117577', permanent: true }
    ];
  },
};
