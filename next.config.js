module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/discover-you-calling', destination: '//wednesdaysatlhwinter-2024', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49179391', permanent: true }
    ];
  },
};
