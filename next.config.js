module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/puntodepartidaenespañol', destination: 'https://my.longhollow.com/Registration/puntodepartidaenespanol-dec2025', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49520929', permanent: true }
    ];
  },
};
