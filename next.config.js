module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/firstrespondermeals', destination: '/first-responder-meals-help-us-care-for-our-first-responders-on-thanksgiving', permanent: true },
      ...
      { source: '/partner', destination: '/thepribblefamily', permanent: true },
      ...
      { source: '/feed', destination: '/first-responder-meals-help-us-care-for-our-first-responders-on-thanksgiving', permanent: true },
      ...
      { source: '/servelink', destination: 'https://longhollow.com/use-your-gifts-at-serve-link', permanent: true },
      ...
      { source: '/easter', destination: '/celebrate-easter-at-long-hollow', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49174865', permanent: true }
    ];
  },
};
