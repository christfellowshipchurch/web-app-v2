module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/kidssummer', destination: '/join-lh-kids-for-a-fun-filled-summer', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/48921495', permanent: true }
    ];
  },
};
