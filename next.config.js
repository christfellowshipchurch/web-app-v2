module.exports = {
  ...
  async redirects() {
    return [
      ...
      // { source: '/notes', destination: 'Current YouVersion notes link weekly', permanent: true },
      ...
      // { source: '/app', destination: 'TBD', permanent: true },
      ...
      { source: '/plan', destination: '/the-2021-ministry-plan', permanent: true },
      ...
      { source: '/deacons', destination: '/', permanent: true },
      ...
      // { source: '/jobs', destination: 'TBD', permanent: true },
      ...
      // { source: '/24', destination: 'TBD - App Page', permanent: true },
      // { source: '/prayer', destination: 'TBD - App Page', permanent: true },
      ...
      // { source: '/pray', destination: 'TBD - App Page', permanent: true },
      ...
      // { source: '/baptism-videos', destination: 'TBD - Baptism Vids', permanent: true },
      { source: '/times-and-locations', destination: '/about/schedule', permanent: true },
