...
const SpanishWordCarousel = styled.div`
  line-height: 45px;
  height: 50px;
  overflow: hidden;
...
WordCarousel.SpanishWordCarousel = SpanishWordCarousel;
WordCarousel.SpanishInner = SpanishInner;
