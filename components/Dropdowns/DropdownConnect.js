      ...
      <HorizontalRow
        ...
        items={[
          ...
          },
          {
            ...
            action: () => router.push('/connect/cr-support'),
          },
          {
            src:
            ...
            action: () => router.push('/connect/life-groups'),
          },
          {
            src:
            ...
            action: () => router.push('/connect/watch-groups'),
          },
          {
            src:
            ...
            action: () => router.push('/connect/get-give-help'),
          },
        ]}
      />
    </Box>
