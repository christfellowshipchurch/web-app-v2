...
const LocationBlockFeature = props => {
  ...
  if (props?.campusName === 'Trinity') {
    ...
    content[0].htmlContent =
      'Every Sunday while you attend service, Christ Fellowship Kids is a place designed just for your kids where they’ll learn to love Jesus, love others, and love life.';
    content[1].subtitle = 'Middle School & High School – Available Regionally';
    content[1].htmlContent =
      'CFStudents is available at just down the road at our Palm Beach Gardens campus location. Your student will find a strong community, learn what it means to follow Jesus, and discover their God-given identity and purpose.';
    content[2].subtitle = 'College & Young Adults – Available Regionally';
    content[2].htmlContent =
      'Christ Fellowship Young Adults meet down the road at our Palm Beach Gardens campus location. Join a community of college students, young adults, and young professionals.';
  }
