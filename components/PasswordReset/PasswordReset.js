  ...
  const { values, handleSubmit, handleChange } = useForm(() => {
    ...
    if (validEmail) {
      ...
      requestEmailPin({
        ...
        onError: () => {
          setError(
            "Oops! That didn't work. Try refreshing your page and try again."
          );
        },
      });
    } else {
  ...
  return (
    <Styled>
      <Styled.HeroSection>
        ...
        <Styled.HeroTitle>Forgot your password?</Styled.HeroTitle>
      </Styled.HeroSection>

      {submitted ? (
        <Styled.ContentSection>
          <Styled.ContentTitle>You're all set!</Styled.ContentTitle>
          <Box as="hr" my="base" />
        ...
        <Styled.ContentSection>
          <Styled.ContentTitle>We can help!</Styled.ContentTitle>
          <Box as="hr" my="base" />
          <Styled.ContentSubtitle>
