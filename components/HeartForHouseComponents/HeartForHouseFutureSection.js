...
const HeartForHouseFutureSection = () => {
  const contentBlockSections = [
    ...
    {
      title:
        '<div style="color: #E63E51; font-size: 28px; margin-bottom: 12px; font-weight: 500; text-decoration: underline;">JUPITER</div>',
      description:
    ...
    {
      title:
        '<div style="color: #E63E51; font-size: 28px; margin-bottom: 12px; font-weight: 500;">CFSEU<div style="margin-left: 6px; display: inline; text-decoration: underline;">HOUSING</div></div> ',
      description:
