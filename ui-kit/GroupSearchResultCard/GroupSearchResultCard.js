/**
 * This is the old GroupCard component that is still used in the GroupsResultsList component. The new GroupCard component is in the GroupCard folder and is used for the GroupList component used in the Connect feed page.
 */
...
import Styled from './GroupSearchResultCard.styles';
import { themeGet } from '@styled-system/theme-get';
import camelCase from 'lodash.camelcase';

const GroupSearchResultCard = (props = {}) => {
...
GroupSearchResultCard.propTypes = {
  ...systemPropTypes,
...
GroupSearchResultCard.defaultProps = {
  avatars: [],
